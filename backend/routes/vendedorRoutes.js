...
router.post('/', authMiddleware, vendedorController.createVendedor);
router.put('/:id', authMiddleware, vendedorController.updateVendedor);
router.delete('/:id', authMiddleware, vendedorController.deleteVendedor);
